...
\input{sections/formal_transition_operator}
\input{sections/cross_cultural_tests}
\input{sections/astronomical_null_models}
\input{sections/divine_calendar}
\input{sections/enuma_relational_genesis}
